...
/**
 * CardTerminalAdministrationRegistrationResponse
 */
public class CardTerminalAdministrationRegistrationResponse   {
  private String cardPOSRegistryOperatingSessionReference = null;

  private String cardPOSRegistrationTaskReference = null;
  ...
  **/
   ...
   * @return cardPOSRegistrationTaskReference
  **/

  public String getCardPOSRegistrationTaskReference() {
    return cardPOSRegistrationTaskReference;
  }

  public void setCardPOSRegistrationTaskReference(String cardPOSRegistrationTaskReference) {
    this.cardPOSRegistrationTaskReference = cardPOSRegistrationTaskReference;
  }


  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier general-info: \"identification of the device\" 
